...
// 将rgb表示方式转换为hex表示方式
gradientColor.prototype.colorHex = hexToRbg

export function hexToRbg (rgb) {
  let _this = rgb;
  let reg = /^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/;
...
export function getColor(param1, param2, param3, param4) {
  let color_list = new gradientColor(param1, param2, param3);
   return color_list[param4]
}
export function getColorlist(param1, param2, param3) {
  let color_list = new gradientColor(param1, param2, param3);
   return color_list;
}
